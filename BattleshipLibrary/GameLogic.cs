...
namespace BattleshipLibrary
{
    public static class GameLogic
    {
        ...
        public static bool PlaceShip(PlayerInfoModel model, string location)
        {
            ...
            bool isValidLocation = ValidateShotGridLocation(model, row, column);
        ...
        private static bool ValidateShotGridLocation(PlayerInfoModel model, string row, int column)
        {
